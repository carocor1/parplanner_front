...
const DatePickerEvento: React.FC<DatePickerEventoProps> = ({ label, onDateChange, minimumDate }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.dropdown} onPress={showDateTimePicker}>
        <Text style={[styles.selectedTextStyle, !currentDate && {color: "#666"}]}>
          {currentDate ? formatDate(currentDate) : "Fecha"} {/* Muestra "Fecha" por defecto */}
        </Text>
      </TouchableOpacity>
