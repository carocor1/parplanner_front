  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contenedorPlanning}>
        <View
          style={
            esPendiente ? styles.rectanguloPendiente : styles.rectanguloAprobada
          }
        >
          <Text
            style={esPendiente ? styles.textoPendiente : styles.textoAprobado}
          >
            {" "}
        ...
        {esCreador && (
          <View style={styles.containerPlanning}>
            <Text style={styles.textoPlanning}>
              PROPONÉS LA SIGUIENTE PLANIFICACIÓN
            </Text>
          </View>
        )}
        ...
        {!esCreador && (
          <View style={styles.containerPlanning}>
            <Text style={styles.textoPlanning}>
              {planning.usuario_creador.nombre.toUpperCase()} PROPONE LA
